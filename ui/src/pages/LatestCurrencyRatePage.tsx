          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(0,0,0,0.07)] overflow-hidden grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-center space-y-4">
                ...
                <div>
                  <h2 className="font-display text-lg font-semibold text-neutral-950">Latest Currency Rate</h2>
                  <p className="text-sm text-neutral-500 mt-1">Get the latest foreign exchange rates and generate a branded post ready for social media.</p>
                </div>
                {(isAdmin || !globalBrand) && (
                  <div>
              ...
              <div className="aspect-video md:aspect-auto bg-[#ECFDF5] flex items-center justify-center">
                <img src="/currency-rate-card.png" alt="Currency Rate" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        )}
