...
export function GoldRatePage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url
      link.download = `gold-rate-${selectedBrand}-${new Date().toISOString().split('T')[0]}.png`
      link.click()
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(0,0,0,0.07)] overflow-hidden grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="aspect-video md:aspect-auto bg-[#ECFDF5] flex items-center justify-center">
                <img src="/gold-rate-card.png" alt="Gold Rate" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        )}
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            <BackButton />
            <h1 className="text-2xl font-semibold text-neutral-950">Latest Gold Rate</h1>
          </div>
          <p className="text-sm text-neutral-600">Generate daily 916 gold price graphics</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:items-stretch">
          ...
          <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(0,0,0,0.07)] overflow-hidden min-h-96 flex flex-col">
            {isLoading ? (
              ...
              <img src={imageUrl} alt="Gold Rate" className="w-full h-auto" />
            ) : (
