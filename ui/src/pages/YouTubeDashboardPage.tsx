...
export function YouTubeDashboardPage() {
  ...
  const targetData = useMemo(() => {
    ...
    let revenueTarget = dailyRevenue
    let label = 'DAILY TARGET'
    if (viewMode === 'weekly') { revenueTarget = dailyRevenue * 7; label = 'WEEKLY TARGET' }
    else if (viewMode === 'monthly') { revenueTarget = dailyRevenue * 30; label = 'MONTHLY TARGET' }

    return { revenueTarget: annualRevenue > 0 ? revenueTarget : null, label }
