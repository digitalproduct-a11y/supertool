...
import { updateTitleInImageUrl, replaceBaseImage, uploadToCloudinary, uploadUrlToCloudinary, extractBaseImageUrl } from '../../utils/imageProvider'
...
export function CarouselResultPreview({ result, articleUrl, onPostDraft }: CarouselResultPreviewProps) {
