              ...
              {[...Array(5)].map((_, idx) => (
                <div key={idx} className="rounded-xl border border-neutral-100 bg-white p-4">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="w-full sm:w-36 aspect-video shrink-0 self-start rounded-lg bg-neutral-100 animate-pulse" />
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row gap-3 p-4">
                      ...
                      <div className="w-full sm:w-36 aspect-video shrink-0 self-start rounded-lg bg-neutral-100 overflow-hidden relative">
                        {article.imageUrl ? (
                          <img
