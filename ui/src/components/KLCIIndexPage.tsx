...
export function KLCIIndexPage() {
  ...
  const webhookUrl = import.meta.env.VITE_KLCI_INDEX_WEBHOOK_URL as string | undefined
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url
      link.download = `klci-index-${selectedBrand}-${new Date().toISOString().split('T')[0]}.png`
      link.click()
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(0,0,0,0.07)] overflow-hidden min-h-96 flex flex-col">
              {isLoading ? (
                ...
                <img src={imageUrl} alt="KLCI Index" className="w-full h-auto" />
              ) : (
