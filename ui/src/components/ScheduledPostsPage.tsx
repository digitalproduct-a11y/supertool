...
import { callGenerateWebhook, GenerateView } from './GeneratePostView'
...
export const RECOMMENDED_SOURCES: Record<string, string[]> = {
  ...
  'Raaga':           ['astro awani', 'astro awani international', 'stadium astro', 'rojak daily'],
  'Hotspot':         ['stadium astro', 'astro awani', 'astro awani international'],
  'MY':              ['xuan', 'hotspot'],
  'Melody':          ['xuan', 'hotspot'],
  'Goxuan':          ['xuan', 'hotspot'],
}
